...
I will create isochrones for areas within a ten-minute walk and a five-minute drive.
...
I will first import Las Vegas neighborhoods and then transform the coordinate system.
```{r}
nhoods <- st_read("https://opendata.arcgis.com/datasets/0629d6512c0d425badf2bd1a366aa41d_0.kml?geometry=%7B%22xmin%22%3A-115.867%2C%22ymin%22%3A36.08%2C%22xmax%22%3A-114.56%2C%22ymax%22%3A36.274%2C%22type%22%3A%22extent%22%2C%22spatialReference%22%3A%7B%22wkid%22%3A4326%7D%7D&outSR=%7B%22latestWkid%22%3A3421%2C%22wkid%22%3A102707%7D", quiet = TRUE)
...
```{r, warning=FALSE}
iso_10min_drive_02 <- otp_isochrone(otpcon = otpcon, fromPlace = points, mode= "CAR", cutoffSec = 600)
```
