...
# Provinces in China
Seeing that Taiwan is not included in this map, I believe that politics are involved in maps.
```{r, message=FALSE}
...
# Joining data
I have made a file with province-level data on COVID-19 cases based on statistics of China's National Health Commission. I can join it with my china_province dataframe.
```{r, message=FALSE}
...
ggplot(covid_provinces,
  ...
  scale_fill_viridis_c(
    name = "Number of \naccumulated\nCOVID-19\ncases till\nSept 18, 2020",
    trans = "log",
    breaks = c(0, 10, 100, 500, 2000, 10000, 50000, 70000),
    labels = formatC(c(0, 10, 100, 500, 2000, 10000, 50000, 70000),
