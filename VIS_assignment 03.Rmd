...
I wanted to know how many public schools are in each Chicago neighborhood. (Metric 5)
```{r}
...
On average, in each Chicago neighborhood, there are 7 public schools. (Metric 15)
...
I am also interested in the density of bus stops (the number of bus stops per square km) of each Chicago neighborhood. (Metric 21)
...
I want to know how far each school is from a bus stop. (Metric 3)
...
I would like to know which neighborhoods have parks in them. (Metric 13)
...
pct_park_nhoods <- n_park_nhoods / nrow(NEIGHBORHOOD_4)
n_park_nhoods
pct_park_nhoods
```
