...
I would like to know: how many of the bus stops in Chicago are within 200 meters of a public school? To figure this out, I will create a new polygon layer to represent a 200-meter buffer around the public schools. 
```{r}
